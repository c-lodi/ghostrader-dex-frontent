...
function Footer() {
    return (
        <>
            <footer className="flex text-center items-center fixed bottom-0 left-0 w-full py-3 px-4 md:px-8 text-xs bg-transparent justify-between">
            <div className="flex">
             
                <a target="_blank" className="flex items-center space-x-2 text-white/50 hover:text-v2-primary cursor-pointer"
                ...
                <div className="hidden md:flex items-center">
                    <a target="_blank" className="h-8 w-6 px-1 py-1.5 text-white/50 hover:text-v2-primary flex items-center"
                        rel="noopener noreferrer" href="">
                    ...
                    <a target="_blank" className="!ml-3 h-6 w-6 px-1 py-1.5 text-white/50 hover:text-v2-primary flex items-center"
                        rel="noopener noreferrer" href="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="#46555f" fill="none">
                    ...
                    <a target="_blank" className="!ml-2 h-6 w-6 px-1 py-1.5 text-white/50 hover:text-v2-primary flex items-center"
